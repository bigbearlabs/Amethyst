#
#  Be sure to run `pod spec lint citrine-extract.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Andy Park" => "sohocoke@gmail.com" }
  # Or just: s.author    = "Andy Park"
  # s.authors            = { "Andy Park" => "sohocoke@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Andy Park"
  ...
  s.source       = { :git => "https://github.com/bigbearlabs/Amethyst.git", :tag => "0.0.1" }
